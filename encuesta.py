...
class EncuestaLimitadaEdad(Encuesta):
    ...
    @property
    def edad_min(self) -> int: return self.__edad_min

    @edad_min.setter
    def edad_min(self, edad_min) -> None: self.__edad_min = edad_min

    @property
    def edad_max(self) -> int: return self.__edad_max

    @edad_max.setter
    def edad_max(self, edad_max) -> None: self.__edad_max = edad_max
...
class EncuestaLimitadaRegion(Encuesta):
    ...
    @property
    def regiones(self) -> List[int]: return self.__regiones

    @regiones.setter
    def regiones(self, regiones) -> None: self.__regiones = regiones
