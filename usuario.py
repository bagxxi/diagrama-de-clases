...
class Usuario():
    ...
    @correo.setter
    def correo(self, correo) -> None: self.__correo = correo

    @property
    def edad(self) -> int: return self.__edad

    @edad.setter
    def edad(self, edad) -> None: self.__edad = edad

    @property
    def region(self) -> List[int]: return self.__region

    @region.setter
    def region(self, region) -> None: self.__region = region
